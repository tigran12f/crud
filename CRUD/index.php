	      ...
	      <div class="modal-body">
	        <form action="" method="post">
	        	<div class="form-group">
	        		<input type="text" class="form-control" name="name" value="" placeholder="Имя студента">
	        	</div>
	        	<div class="form-group">
	        		<input type="text" class="form-control" name="groupe" value="" placeholder="Группа">
	        	</div>
	        	<div class="form-group">
	        		<input type="text" class="form-control" name="year" value="" placeholder="Год рождения">
	        	</div>
				<div class="form-group">
	        		<input type="text" class="form-control" name="edu" value="" placeholder="Образование">
	        	</div>
				<div class="form-group">
	        		<input type="text" class="form-control" name="email" value="" placeholder="Электронная почта">
	        	</div>
				<div class="form-group">
	        		<input type="text" class="form-control" name="photo" value="" placeholder="Фото">
	        	</div>
	      </div>
